export default function DashboardPage() {
  return (
    <div className="px-6 py-8 max-w-3xl mx-auto pb-24 md:pb-8">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-foreground">Hey, welcome 🌹</h1>
      ...
      <div className="grid grid-cols-2 gap-3">
        {[
          ...
          <a key={a.href} href={a.href} className="bg-card border border-border rounded-2xl p-4 hover:border-primary/40 hover:bg-primary/5 transition-colors group">
